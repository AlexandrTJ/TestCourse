...
public class User {
    ...
    public static List<User> getAllUsers(){
        return new ArrayList<>(allUsers.values()); //  values() - получить все значения из коллекции
    }

    public static List<User> getAllUsers(Sex sex){ // формировать список пользователей по полу
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass()) return false; //один или оба истинны возвращает true
        User user = (User) o;
        return age == user.age && // возвращает true когда оба операнда истинны
